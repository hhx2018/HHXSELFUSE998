...
// 此句话出错！var policy = $environment.executeType == 0 || $environment.executeType == "0" || $environment.executeType == "-1"? '🥺 送中节点'
...
function Check() {
    ...
    setTimeout(() => {
        console.log("⛳️ 共计 "+OKList.length+" 个：送中节点 ➟ "+ OKList)
